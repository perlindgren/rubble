...
// use accelerometer::Accelormeter;
...
const APP: () = {
    ...
    fn init() {
        hprintln!("\n<< INIT >>\n").ok();
        //let dwm1001 = DWM1001::new(core, peripherals);
        // let dwm1001 = unsafe {
        //     DWM1001::steal();
        // };
        ...
        let lis2dh12_raw = dwm1001::new_acc_twim(device.TWIM1, p0.p0_28, p0.p0_29);
        let address = lis2dh12::SlaveAddr::Alternative(true);

        let mut lis2dh12 =
            lis2dh12::Lis2dh12::new(lis2dh12_raw, address).expect("lis2dh12 new failed");
